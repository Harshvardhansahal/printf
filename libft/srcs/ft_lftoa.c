...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/15 18:38:30 by jdugoudr          #+#    #+#             */
/*   Updated: 2019/02/07 09:13:59 by jdugoudr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static uintmax_t	dec_precision(long double n, int precision, int more_pre)
{
	uintmax_t	nb_d;
	...
	if (nb_d % 10 == 5)
		...
		nb_d = (nb_d / ft_exp(more_pre + 1)) + 1;
	else
		nb_d = (nb_d / ft_exp(more_pre + 1));
	return (nb_d);
}
